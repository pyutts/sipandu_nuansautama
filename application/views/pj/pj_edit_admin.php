                    ...
                    <div class="row">
                        <div class="col-md-6">
                            ...
                            <div class="mb-3">
                                ...
                                <input type="hidden" name="wilayah_id" value="<?= $pj->wilayah_id ?>">
                            </div>
                            <div class="mb-3">
...
<script>
    ...
    $(document).ready(function() {
        ...
        const initialLat = parseFloat('<?= set_value('latitude', $pj->latitude) ?>') || -8.7903;
        const initialLng = parseFloat('<?= set_value('longitude', $pj->longitude) ?>') || 115.1726;

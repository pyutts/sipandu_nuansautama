...
<div class="container-fluid">
    <div class="card">
        <div class="card-body">
            ...
            <form action="<?= base_url('dashboard/penghuni/update/admin/'. $penghuni->uuid) ?>" method="POST" enctype="multipart/form-data">
                <div class="row">
                    <!-- ALERT PERHATIAN -->
                    <div class="row mb-4">
                        <div class="col-md-12">
                    ...
                    <div class="col-md-6">
                        ...
                        <div class="mb-3">
                            ...
                            <select name="penanggung_jawab_id" id="penanggung_jawab_id" class="form-select" required>
                                ...
                                <?php foreach ($pj as $p): ?>
                                    <option value="<?= $p->id ?>" <?= set_select('penanggung_jawab_id', $p->id, ($penghuni->penanggung_jawab_id == $p->id)) ?> >
                                        <?= $p->nama_pj ?>
                                    </option>
                                <?php endforeach; ?>
                            </select>
        ...
        $('#usePJLocation').change(function() {
            ...
            if (!pj_id) {
                ...
                success: function(response) {
                    if (response.success) {
                        const { latitude, longitude, alamat_detail, alamat_no, alamat_maps } = response.data;

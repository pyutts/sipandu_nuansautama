            ...
            <div class="card-body">
                ...
                <form action="<?= base_url('dashboard/admin/update/' . $admin->uuid) ?>" method="POST">
                    <div class="mb-3">
                        ...
                        <input type="text" name="username" class="form-control <?= form_error('username') ? 'is-invalid' : '' ?>" id="username" value="<?= set_value('nama', $admin->username); ?>" required>
                        <?= form_error('username', '<div class="invalid-feedback">', '</div>'); ?>
                    </div>
                    
                    <div class="mb-3">
                        <label for="nama" class="form-label">Nama</label>
                        <input type="text" name="nama" class="form-control <?= form_error('nama') ? 'is-invalid' : '' ?>" id="nama"  value="<?= set_value('nama', $admin->nama); ?>" required>
